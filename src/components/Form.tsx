...
export default function Form({dispatch, state} : FormProps) {
  ...
  return (
    <form className="space-y-5 bg-white shadow p-10 rounderd-lg"
    onSubmit={handleSubmit}>
        ...
        placeholder="Ej: Hamburguesa, queso, correr 5 km, natación, ensalada..."
        value={activity.name}
        onChange={handleChange}
        />
        </div>
        ...
        type="number"
        className="border border-slate-300 p-2 rounded-lg"
        placeholder="Calorias. ej. 300, 500, 660..."
